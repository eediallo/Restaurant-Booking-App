...
@app.get("/booking/{booking_reference}", include_in_schema=False)
@app.get("/booking-history", include_in_schema=False)
@app.get("/availability", include_in_schema=False)
@app.get("/availability/{restaurant_name}", include_in_schema=False)
@app.get("/review/{booking_reference}", include_in_schema=False)
